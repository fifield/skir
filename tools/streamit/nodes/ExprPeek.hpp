 ...
 */
#ifndef _EXPRPEEK_HPP_
#define _EXPRPEEK_HPP_
 ...
 */
class ExprPeek : public Expression
{
private:
    Expression *expr;
...
public:
     ...
     */
    ExprPeek(FEContext *context, Expression *expr) : Expression(context)
    {
        this->expr = expr;
    }
